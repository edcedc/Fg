...
public class MacAddressTool {
    ...
    public static String getMacAddress(){
        ...
        if (!StringUtils.isEmpty(macAddress)){
            ...
            String macAddressFromIp = getMacAddressFromIp(Utils.getApp().getApplicationContext());
            if (!StringUtils.isEmpty(macAddressFromIp)){
                return macAddressFromIp.replaceAll(":", "");
            }else {
                return mac;
            }
        }
