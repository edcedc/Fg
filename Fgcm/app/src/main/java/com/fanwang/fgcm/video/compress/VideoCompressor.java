package com.fanwang.fgcm.video.compress;
...
public class VideoCompressor {
    ...
    private static String mOutputFile = AppUtil.getAppDir() + "/" + TimeUtils.getNowMills() + ".mp4";
    ...
    private static void init(Context context){
        ...
        LogUtils.e("License check RC: " + rc);
    }
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    LogUtils.e("compress exception:"+e.getMessage());
                }
            }
        }.start();
...
//                            listener.onProgress(100);
                    ...
                    LogUtils.e("threadmessage:"+e.getMessage());
                }
            }
        }.start();
    }
