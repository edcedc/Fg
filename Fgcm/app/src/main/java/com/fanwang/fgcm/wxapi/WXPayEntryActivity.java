	...
	public void onResp(BaseResp resp) {
		...
		switch (resp.errCode){
			case 0://支付成功
				...
				EventBusActivityScope.getDefault(this).post(new BundleDataInEvent(BundleDataInEvent.wx_pay));
				EventBus.getDefault().post(new BundleDataInEvent(BundleDataInEvent.wx_pay));
				break;
			case -1:
				//支付失败
