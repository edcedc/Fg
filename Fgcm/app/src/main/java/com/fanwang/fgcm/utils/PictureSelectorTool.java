...
public class PictureSelectorTool {
    ...
    public static void PictureSelectorImage(Activity act, List<LocalMedia> selectionMedi){
        PictureSelectorImage(act, selectionMedi, 9, PictureConfig.CHOOSE_REQUEST);
    }
    public static void PictureSelectorImage(Activity act, int requst){
        PictureSelectorImage(act, null, 1, requst);
    }

    public static void PictureSelectorImage(Activity act, List<LocalMedia> selectionMedi, int number, int requst){
