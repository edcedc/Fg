...
public class TVCClient {
    ...
    private void parseInitRsp(String rspString) {
        ...
        try {
            ...
            if (serverTS > 0 && localTS - serverTS > 10 * 60) {
    ...
    private void uploadCosCover() {
        ...
        putObjectRequest.setSign(reqTime/1000L - localTimeAdvance, reqTime/1000L - localTimeAdvance + 600);
            ...
            public void run() {
                ...
                try {
                    ...
                    if (isResumeUploadVideo()) {
                        ...
                        initMultipartUploadRequest.setSign(reqTime/1000L - localTimeAdvance, reqTime/1000L - localTimeAdvance + 600);
